...
const translations = {
  ...
  th: {
    ...
    aboutIntroDesc: "สวัสดีครับ ผมเป็นนักพัฒนาซอฟต์แวร์และผู้สนใจด้านระบบวิศวกรรมที่มีความหลงใหลในการพัฒนาเว็บ การออกแบบระบบ และการคิดเชิงระบบ ผมรักการเรียนรู้เทคโนโลยีใหม่ๆ และชอบสร้างแอปพลิเคชันที่ทันสมัย ทรงพลัง และยืดหยุ่น โดยมุ่งเน้นการเขียนโค้ดที่สะอาดควบคู่กับตรรกะระบบที่เสถียร",
